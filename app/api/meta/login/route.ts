...
export async function GET() {
  ...
  // Permissões para App tipo Consumidor
  const scopes = 'public_profile,email,pages_show_list,pages_read_engagement,pages_manage_posts,instagram_manage_insights,instagram_content_publish'
