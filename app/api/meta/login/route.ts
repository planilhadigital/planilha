...
export async function GET() {
  ...
  const scopes = 'public_profile,pages_show_list,pages_read_engagement,pages_manage_posts,instagram_manage_insights,instagram_content_publish,business_management'
